...
def define_D(input_nc, 
    ...
    net = _MultiscaleDiscriminator(input_nc, 
                                   ndf, 
                                   n_layers, 
                                   num_D, 
                                   norm, 
...
def define_featureD(input_nc, 
    ...
    net = _FeatureDiscriminator(input_nc, 
                                n_layers, 
                                norm, 
                                activation, 
                                gpu_ids)
...
class _PreUNet16(nn.Module):
    ...
    def forward(self, data):
        conv1 = self.pool(self.conv1(data))
